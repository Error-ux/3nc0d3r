...
import config
from utils.media import async_generate_thumbnail, get_vmaf, upload_to_cloud
from utils.rename import format_track_report
from utils.ui import format_time, upload_progress
...
async def main():
    ...
    try:
        ...
        # Convert Pyrogram InlineKeyboardButtons to (text, url) tuples for Telethon
        buttons_data = []
